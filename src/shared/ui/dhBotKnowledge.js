...
export const RESPONSES = [
  /* ── 인사 ── */
  {
    ...
    text: "안녕하세요! 😊 박도현의 포트폴리오 챗봇 DH Bot입니다.\n시스템·게임·AI·제품의 경계를 연결하는 개발자 박도현에 대해 편하게 물어보세요!",
  ...
  /* ── 이름 / 소개 ── */
  {
    ...
    text: "저는 **박도현(DoHyun Park)**을 대신하는 챗봇이에요! 🤖\n\n박도현은 백엔드를 탄탄한 기반으로 삼되, **Systems · Game · AI · Product**를 연결해 아이디어를 작동하는 소프트웨어로 만드는 개발자입니다. Java와 Spring Boot뿐 아니라 React, Phaser와 AI Guardrail도 실제 프로젝트에서 다룹니다.",
  ...
  /* ── 프로젝트 전체 목록 ── */
  {
    ...
    text: "🗂️ **대표 프로젝트**\n\n1. **VIBE:UNBOUND**\n   자연어 명령과 자동전투의 결과를 책임 로그로 되짚는 AI 방치형 RPG\n\n2. **대학물품관리시스템 U-sto**\n   공공데이터와 학내 자산 생애주기를 연결한 시스템\n\n3. **키즈카페로봇 Kids-Friends**\n   Temi 로봇·센서·AI·웹을 연결한 서비스 자동화\n\n각 프로젝트에 대해 자세히 알고 싶으면 물어보세요!",
    quickReplies: ["VIBE:UNBOUND 알려줘", "물품관리 자세히 알려줘", "키즈카페 로봇 알려줘"],
  },

  /* ── 프로젝트: VIBE:UNBOUND ── */
  {
    keywords: ["vibe", "unbound", "바이브", "게임", "방치형", "phaser", "루프", "자동전투"],
    text: "🎮 **VIBE:UNBOUND**\n\n자연어 명령을 제한된 규칙으로 컴파일하고, 자동전투에서 반복해 만든 결과를 책임 로그로 되짚는 AI 방치형 RPG입니다.\n\nReact는 HUD와 명령 작성 경험을, Phaser 3는 월드와 전투를 담당합니다. 결정적 GameEngine·동일 Seed 회귀 검증과 AI Schema/Guardrail로 명령 변경의 영향을 비교하고 안전 경계를 유지합니다.\n\n현재 Vertical Slice를 개발 중이며 [vibe-unbound.com](https://vibe-unbound.com/)에서 체험할 수 있습니다.",
    quickReplies: ["다른 프로젝트도 알려줘", "어떤 개발자인가요?"],
  },
  ...
  /* ── Flutter 관련 ── */
  {
    ...
    text: "📱 **Flutter / 프론트엔드**\n\n금연쉼터에서는 Flutter 앱을, VIBE:UNBOUND에서는 React 제품 화면과 Phaser 게임 런타임을 구현했습니다.\n\n백엔드(Spring Boot)를 기술적 기반으로 두면서도 화면, 인터랙션, 게임 시스템까지 문제 해결에 필요한 영역을 직접 연결합니다.",
  ...
  /* ── 비전 / 목표 ── */
  {
    ...
    text: "🎯 **커리어 비전**\n\n박도현의 장기 목표는 **분야 사이의 경계를 연결하고 조직의 기술 핵심을 책임지는 개발자**가 되는 것입니다.\n\n- 안정적인 시스템과 데이터 흐름 설계\n- 게임 규칙과 인터랙티브 경험 구현\n- 검증 가능한 AI와 자동화의 안전 경계 설계\n- 기술 선택부터 실제 운영까지 제품 전체를 이해\n\n한 직무명보다 문제에 필요한 역량을 확장하는 방향을 지향합니다. 💡",
  ...
  /* ── 철학 / 개발 스타일 ── */
  {
    ...
    text: "💭 **개발 철학**\n\n박도현이 중요하게 생각하는 것들:\n\n1. 기술보다 먼저 **문제와 사용 흐름**을 정의하기\n2. 상태·트랜잭션·AI의 **책임 경계**를 명확히 하기\n3. 복잡한 추상화보다 읽고 검증할 수 있는 구조 만들기\n4. 결과뿐 아니라 판단 근거와 실패 기록도 남기기\n\n분야가 달라도 실제로 작동하고 설명 가능한 소프트웨어를 만듭니다. 🎯",
